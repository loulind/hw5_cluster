...
df_n2 <- read_csv("~/work/task1data/df_n2.csv")
df_n3 <- read_csv("~/work/task1data/df_n3.csv")
df_n4 <- read_csv("~/work/task1data/df_n4.csv")
df_n5 <- read_csv("~/work/task1data/df_n5.csv")
df_n6 <- read_csv("~/work/task1data/df_n6.csv")
